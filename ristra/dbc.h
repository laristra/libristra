...
#define InOpenRange(x,mn,mx) ::ristra::dbc::in_open_range_func(x,mn,mx,#x,__FILE__,__FUNCTION__,__LINE__);
/*! \def GreaterThan(x,min): Assert x > min */
#define GreaterThan(x,mn) ::ristra::dbc::greater_than_func(x,mn,#x,__FILE__,__FUNCTION__,__LINE__);
/*! \def GreaterEqual(x,min): Assert x >= min */
#define GreaterEqual(x,mn) ::ristra::dbc::greater_equal_func(x,mn,#x,__FILE__,__FUNCTION__,__LINE__);
/*! \def LessThan(x,max): Assert x < max */
#define LessThan(x,mx) ::ristra::dbc::less_than_func(x,mx,#x,__FILE__,__FUNCTION__,__LINE__);
